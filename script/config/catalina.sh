...
JAVA_OPTS=${java_agent}" -XX:+TieredCompilation -XX:-UseGCOverheadLimit -XX:+PrintGC -XX:+PrintGCDetails -XX:MetaspaceSize=512m -XX:MaxMetaspaceSize=512m -Xms2048m -Xmx2048m -Xss2m -Dfile.encoding=UTF8 -Dsun.jnu.encoding=UTF8"
